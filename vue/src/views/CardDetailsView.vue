    ...
    <div class="page-container">
        <div class="card-container">
            ...
            <div class="card-footer">
                <button @click="removeFromCollection" class="plus-minus" title="Remove from collection">
                    -
                </button>
                <div class="card-count">{{ this.cardCount }}</div>
                <button @click="addToCollection" class="plus-minus" title="Add to collection">
                    +
                </button>
            </div>
        </div>
        ...
        <div class="details-container">
            ...
            <div class="format-container">
                <div v-for="(status, format) in card.legalities" :key="format" :class="{
