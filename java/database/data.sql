...
INSERT INTO collections(collection_name, user_id, username, is_public, thumbnail_url) VALUES ('user''s Collection', 1, 'user', false, '');
INSERT INTO collections(collection_name, user_id, username, is_public, thumbnail_url) VALUES ('admin''s Collection', 2, 'admin', true, '');
